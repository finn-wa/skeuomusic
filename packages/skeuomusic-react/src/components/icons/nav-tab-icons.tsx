...
export function NavTabMoreIcon() {
  return (
    <svg viewBox="0 0 72 60">
      <title>More</title>
      <defs>
        <filter id="circleEffects" colorInterpolationFilters="sRGB">
          <feOffset dx="0" dy="3" />
          <feGaussianBlur result="blur" stdDeviation="2.5" />
          <feFlood floodColor="black" floodOpacity="0.6" result="flood" />
          <feComposite in="flood" in2="SourceGraphic" operator="in" result="composite" />
          <feBlend in="blur" in2="composite" />
        </filter>
        <filter id="glow">
          <feDropShadow dx="0" dy="1" stdDeviation="1" floodColor="white" />
        </filter>
        ...
        <g id="prettyCircle">
          ...
          <use href="#circle" clipPath="url(#circleClip)" filter="url(#circleEffects)" />
        </g>
      </defs>
...
export function NavTabSongsIcon() {
  return (
    <svg viewBox="0 0 72 60">
      <title>Songs</title>
      <defs>
        <filter id="noteEffects" colorInterpolationFilters="sRGB">
          <feOffset dx="0" dy="3" />
          <feGaussianBlur result="blur" stdDeviation="2.5" />
          <feFlood floodColor="black" floodOpacity="0.6" result="flood" />
          <feComposite in="flood" in2="SourceGraphic" operator="in" result="composite" />
        ...
        >
          <stop stopColor="#7c7c7cff" offset="15%" />
          <stop stopColor="#c1c1c1ff" offset="85%" />
        </linearGradient>
      ...
      <g>
        ...
        <use href="#note" clipPath="url(#noteClip)" filter="url(#noteEffects)" />
      </g>
    </svg>
  );
}
...
export function NavTabPlaylistsIcon() {
  return (
    <svg viewBox="0 0 72 60">
      ...
      <defs>
        <filter id="playlistsEffects" colorInterpolationFilters="sRGB">
          <feOffset dx="0" dy="3" />
          <feGaussianBlur result="blur" stdDeviation="2.5" />
          <feFlood floodColor="black" floodOpacity="0.6" result="flood" />
          <feComposite in="flood" in2="SourceGraphic" operator="in" result="composite" />
...
export function NavTabAlbumIcon() {
  return (
    <svg viewBox="0 0 72 60">
      <title>Albums</title>
      <defs>
        <filter id="albumsEffects" colorInterpolationFilters="sRGB">
          <feOffset dx="0" dy="3" />
          <feGaussianBlur result="blur" stdDeviation="2.5" />
          <feFlood floodColor="black" floodOpacity="0.6" result="flood" />
          <feComposite in="flood" in2="SourceGraphic" operator="in" result="composite" />
...
export function NavTabArtistIcon() {
  return (
    <svg viewBox="0 0 78 60">
      <title>Artists</title>
      <defs>
        <filter id="artistsEffects" colorInterpolationFilters="sRGB">
          <feOffset dx="0" dy="3" />
          <feGaussianBlur result="blur" stdDeviation="2.5" />
          <feFlood floodColor="black" floodOpacity="0.6" result="flood" />
          <feComposite in="flood" in2="SourceGraphic" operator="in" result="composite" />
