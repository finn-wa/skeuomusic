...
export interface LibraryApiCreatePlaylistForUserRequest {
  userId: string;
  createPlaylistRequest?: CreatePlaylistRequest;
}
...
export class LibraryApi extends runtime.BaseAPI {
   ...
   * course, own the playlist.) Change Playlist Details
   */
   ...
   * artists, users, and playlists. Check User's Saved Items
   */
  ...
  async checkLibraryContains(
    ...
    const response = await this.checkLibraryContainsRaw(
      requestParameters,
      initOverrides,
    );
    return await response.value();
  ...
  async createPlaylistForUserRaw(
    requestParameters: LibraryApiCreatePlaylistForUserRequest,
    initOverrides?: RequestInit | runtime.InitOverrideFunction,
  ): Promise<runtime.ApiResponse<PlaylistObject>> {
   ...
   * library. Get User's Saved Tracks
   */
  ...
  /**
   * Remove one or more items from the current user's library. Accepts Spotify
   * URIs for tracks, albums, episodes, shows, audiobooks, users, and playlists.
  ...
  /**
   * Add one or more items to the current user's library. Accepts Spotify URIs
   * for tracks, albums, episodes, shows, audiobooks, users, and playlists. Save
   * Items to Library
   */
