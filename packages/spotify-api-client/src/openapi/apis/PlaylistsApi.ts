...
export class PlaylistsApi extends runtime.BaseAPI {
  ...
  /** Get a playlist owned by a Spotify user. Get Playlist */
  ...
  /**
   * Get the current image associated with a specific playlist. Get Playlist
   * Cover Image
   */
   ...
   * **Note**: This endpoint is only accessible for playlists owned by the
   * current user or playlists the user is a collaborator of. A `403 Forbidden`
   * status code will be returned if the user is neither the owner nor a
   * collaborator of the playlist. Get Playlist Items
   */
   ...
   * operation can be used for replacing or clearing items in a playlist. <br/>
   * **Note**: Replace and reorder are mutually exclusive operations which share
   * the same endpoint, but have different parameters. These operations can't be
  ...
  /**
   * Replace the image used to represent a specific playlist. Add Custom
